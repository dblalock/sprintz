...
We introduce \mine, a compression algorithm for multivariate integer time series that achieves state-of-the-art compression ratios and speeds of up to 3GB/s in a single thread. \minesp compression imposes extremely small memory requirements, making it suitable for both compression at the network edge and server-side compression in the presence of massive numbers of streams. % Data stored in \minesp format can be queried at nearly the speed of uncompressed data for even lightweight queries. Moreover,
